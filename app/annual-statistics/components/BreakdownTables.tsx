...
const styles = {
  ...
  table: 'bg-white border border-[var(--color-border-light)] p-6 shadow-sm',
  tableTitle: 'text-xl font-semibold text-[var(--color-text)] mb-4 border-b-2 border-[var(--color-primary-action)] pb-2',
  scrollContainer: 'overflow-y-auto max-h-[300px]',
  row: 'flex justify-between items-center py-3',
  rowBorder: 'border-b border-[var(--color-border-lighter)]',
  ...
  count: 'font-bold text-[var(--color-primary-action)] text-base'
};
